...
<path d="M36.0093 20.7445C38.6142 20.7445 40.4494 19.3437 40.4494 17.0508C40.4494 14.5475 38.387 13.8995 36.4493 13.2907C34.5965 12.7307 34.1236 12.3307 34.1236 11.5755C34.1236 10.8755 34.7189 10.3498 35.7325 10.3498C36.9741 10.3498 37.6381 10.9979 38.0749 11.9259L40.103 10.7523C39.2814 9.03301 37.7397 8.00018 35.7293 8.00018C33.6316 8.00018 31.7084 9.33062 31.7084 11.6411C31.7084 13.9699 33.5268 14.7612 35.3973 15.3004C37.2157 15.8252 38.0373 16.1756 38.0373 17.086C38.0373 17.7684 37.5301 18.3812 36.0789 18.3812C34.5589 18.3812 33.7012 17.646 33.2644 16.5076L31.2012 17.7156C31.8652 19.5365 33.5092 20.7445 36.0093 20.7445Z" fill="gray"/>
<path d="M46.1315 11.501C44.8515 11.501 43.9291 11.9738 43.2995 12.7811V11.7466H41.041V24.0005H43.2963V19.4668C43.9259 20.2717 44.8523 20.7469 46.1283 20.7469C48.4708 20.7469 50.394 18.7332 50.394 16.1252C50.394 13.5171 48.474 11.501 46.1315 11.501ZM45.7123 18.5916C44.3307 18.5916 43.2995 17.5932 43.2995 16.1228C43.2995 14.6523 44.3307 13.6547 45.7123 13.6547C47.1108 13.6547 48.142 14.6523 48.142 16.1228C48.142 17.5932 47.1108 18.5916 45.7123 18.5916Z" fill="gray"/>
<path d="M55.9734 11.5011C54.8022 11.5011 53.8934 11.9387 53.3685 12.7267V8.24658H51.1133V20.4997H53.3685V15.7732C53.3685 14.2531 54.1902 13.6019 55.2886 13.6019C56.3022 13.6019 57.019 14.2147 57.019 15.4052V20.4997H59.2807V15.1252C59.2807 12.8003 57.8262 11.5011 55.9734 11.5011Z" fill="gray"/>
<path d="M62.2351 17.0508H68.8256C68.8827 16.7447 68.9122 16.4341 68.9136 16.1228C68.9136 13.5499 67.0776 11.501 64.4903 11.501C61.7454 11.501 59.875 13.5147 59.875 16.1228C59.875 18.7308 61.7278 20.7445 64.6647 20.7445C66.3448 20.7445 67.6544 20.0621 68.476 18.8716L66.6584 17.8212C66.2736 18.3284 65.5743 18.6964 64.6999 18.6964C63.5111 18.6964 62.5495 18.206 62.2351 17.0508ZM62.1999 15.3003C62.4623 14.1803 63.2839 13.5323 64.4903 13.5323C65.4343 13.5323 66.3784 14.0395 66.6584 15.3003H62.1999Z" fill="gray"/>
<path d="M71.8705 13.2523V11.7467H69.6152V20.4997H71.8705V16.3156C71.8705 14.4755 73.3569 13.9523 74.5282 14.0923V11.5715C73.4265 11.5715 72.3225 12.0619 71.8705 13.2523Z" fill="gray"/>
<path d="M79.293 20.7445C81.8627 20.7445 83.926 18.7308 83.926 16.1228C83.926 13.5147 81.8627 11.501 79.293 11.501C76.7234 11.501 74.6777 13.5147 74.6777 16.1228C74.6777 18.7308 76.7226 20.7445 79.293 20.7445ZM79.293 18.5388C77.9642 18.5388 76.933 17.5412 76.933 16.1228C76.933 14.7043 77.9642 13.7067 79.293 13.7067C80.6387 13.7067 81.6707 14.7051 81.6707 16.1228C81.6707 17.5404 80.6427 18.5388 79.293 18.5388Z" fill="gray"/>
<path d="M89.4976 11.501C88.3264 11.501 87.4176 11.9386 86.892 12.7267V11.7466H84.6367V20.4997H86.892V15.7731C86.892 14.2531 87.7144 13.6019 88.812 13.6019C89.8265 13.6019 90.5433 14.2147 90.5433 15.4051V20.4997H92.8017V15.1251C92.8017 12.8003 91.3505 11.501 89.4976 11.501Z" fill="gray"/>
      ...
      <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
          <div>
              <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                  ...
                  <GiCrossedChains className='h-5 w-5 text-primary-600 dark:text-primary-300'/>
              </div>
              <h3 class="mb-2 text-xl font-bold dark:text-white">Decentralized</h3>
              <p class="text-gray-500 dark:text-gray-400">No Single entity is controlling your data.</p>
          </div>
          <div>
              <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                  ...
                  <MdVpnKey  className='h-5 w-5 text-primary-600 dark:text-primary-300'/>
              </div>
              <h3 class="mb-2 text-xl font-bold dark:text-white">Google Auth</h3>
              <p class="text-gray-500 dark:text-gray-400">Start using Zapix just by authenticating with google</p>
          </div>
          <div>
              <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white">MPC Wallet</h3>
              <p class="text-gray-500 dark:text-gray-400">No need to worry for your private keys, get started with minting your LIT PKP.</p>
          </div>
          <div>
              <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                  <IoMdLock className='h-5 w-5 text-primary-600 dark:text-primary-300'/>
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white">Encrypted Chats</h3>
              <p class="text-gray-500 dark:text-gray-400">Share encrypted images in your chat, only authorized user can decrypt.</p>
          </div>
          <div>
              <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white">Minimal UI</h3>
              <p class="text-gray-500 dark:text-gray-400"> Use the app as you would use a Web2 App</p>
          </div>
